This is a virtual reality demonstration made in Unity by Tanner Samples. To play, open the "DEMO_IS_IN_HERE folder" and run "XRI Examples.exe". This only works on Windows.
